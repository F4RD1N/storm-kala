...
const CatagoryId = ({userData}) => {
  ...
  return (
    <div>
      ...
      <br />
      <marquee loop="100" width="100%" direction="top" height="50px">Hello Mother Fucker</marquee>
...
export const getServerSideProps = async ({ query }) => {
  ...
  console.log(currentPage)
    ...
    let userData = null
    try {
      const res = await fetch(`https://api.digikala.com/v1/categories/mobile-phone/search/?page=${currentPage}`)
      if (res.status !== 200) {
